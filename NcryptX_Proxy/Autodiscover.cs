...
namespace NcryptX_Proxy
{
    public class Autodiscover
    {
        ...
        public Autodiscover(RequestDelegate nextMiddleware, ILogger<NcryptXProxyMiddleware> logger, HttpClient httpClient)
        {
        ...
        public async Task Invoke(HttpContext context)
        {
            ...
            try
            {
                ...
                var exception = "Sucessfully Called Autodiscover";
